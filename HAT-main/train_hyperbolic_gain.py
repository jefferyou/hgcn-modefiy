...
def parse_args():
    ...
    parser.add_argument('-dataset', nargs='?', default='osm_inductive', help='osm_transductive or osm_inductive')
    parser.add_argument('-prefix', nargs='?', default='sweden-osm', help='linkoping-osm or sweden-osm')
    ...
    parser.add_argument('-c', default=0.5, type=int, help='0: untrainable curvature; 1: trainable curvature')
