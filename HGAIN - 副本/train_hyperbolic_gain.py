...
def parse_args():
    ...
    parser.add_argument('-prefix', nargs='?', default='munich-osm', help='linkoping-osm or sweden-osm drsd-osm venice-osm italy-osm  athens-osm')
    ...
    parser.add_argument('-epochs', default=1200, type=int, help='maximum number of epochs')
