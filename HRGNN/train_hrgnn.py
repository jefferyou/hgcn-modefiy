...
def parse_args():
    parser = argparse.ArgumentParser(description='Train HRGNN on OpenStreetMap datasets')
    ...
    parser.add_argument('-prefix', nargs='?', default='venice-osm', help='venice-osm  munich-osm  athens-osm i taly-osm ')
    ...
    parser.add_argument('-dfs_steps', type=int, default=5, help='Number of DFS steps for global walks')
        ...
        with tf.Session(config=config) as sess:
            ...
            for epoch in range(nb_epochs):
                ...
                if val_loss_avg / vl_step <= vlss_mn:
                    ...
                    vacc_mx = val_acc_avg / vl_step  # 记录对应的准确率，但不用于决策
                    vlss_mn = val_loss_avg / vl_step
                    curr_step = 0
                ...
                #     vlss_mn = val_loss_avg / vl_step  # 记录对应的损失，但不用于决策
                #     curr_step = 0
