...
def parse_args():
    ...
    parser.add_argument('-dataset', nargs='?', default='osm_transductive', help='osm_transductive or osm_inductive osm_drsd')
    parser.add_argument('-prefix', nargs='?', default='venice-osm', help='linkoping-osm or sweden-osm drsd-osm  venice-osm   italy-osm')
